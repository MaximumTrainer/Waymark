...
- API default connection string in `src/backend/OpenOnboarding.Api/appsettings.json` currently references `open_onboarding` (different from compose's `onboarding`).
